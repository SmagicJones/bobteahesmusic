...
//   // Helper function to render file attachment
...
//     return (
//       <div className="mt-3 p-3 bg-white dark:bg-slate-600 rounded-lg border border-gray-300">
//         <div className="flex items-center gap-2 mb-2">
//           <span className="text-2xl">
//             {isImage ? "🖼️" : isPDF ? "📄" : "📎"}
//           </span>
...
//         </section>
//         <section pt-4>
//           <h3 className="text-2xl text-center p-4">Testing</h3>
