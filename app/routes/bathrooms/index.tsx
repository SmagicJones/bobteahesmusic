    ...
    <main>
      <header className="bg-purple-300 dark:bg-slate-900">
        <div className="grid md:grid-cols-2 gap-4 p-4">
          <div className="flex items-center ">
            <div>
              <h2 className="text-4xl">Your Bathroom ready for an uplift?</h2>
      ...
      <section className="bg-purple-200 dark:bg-slate-800">
        <div className="p-4 flex justify-center items-center">
          <div>
            <h3 className="text-center text-2xl">Our Completed Bathrooms</h3>
          </div>
        </div>
        <div className="grid md:grid-cols-2 gap-4 p-4 m-2">
          {bathrooms.map((bathroom) => (
            <Card>
              ...
              <CardContent>{bathroom.short_content}</CardContent>
              <CardFooter>
                <Link to={`/bathrooms/${bathroom.slug}`}>
